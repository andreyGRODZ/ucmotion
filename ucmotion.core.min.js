...
(function (w,d){'use strict';
  ...
  function ensureWrapped(atom,mode){
    ...
    // режем по тегам, текст — на слова/пробелы, сохраняя сущности
    ...
    // ждём рендер → расширяем курсивные слова → строим строки
    requestAnimationFrame(()=>{
      // 1) расширяем курсивные слова, чтобы Safari не резал правые свесы
      expandItalicWords(atom);

      // 2) группируем «плоских» детей по offsetTop в .uc-line
      ...
      for(const item of lines){
        ...
        if(item.isGap){ 
          ...
          // авто-bleed для маски строки от кегля
